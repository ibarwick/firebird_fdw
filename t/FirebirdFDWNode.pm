...
use if $ENV{VERSION_NUM} >= 150000, 'PostgreSQL::Test::Cluster';
use if $ENV{VERSION_NUM} >= 150000, 'PostgreSQL::Test::Utils';
use if $ENV{VERSION_NUM}  < 150000, 'PostgresNode';
